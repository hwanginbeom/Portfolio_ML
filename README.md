...
## #4. Project - 수요 예측을 통한 물류 최적화 시스템

- Background

농식품 빅데이터 온라인 해커톤으로서 각 농식품의 수요예측을 통해 물류를 최적화하는 시스템을 구현하였습니다.
...
<br>
 ...
 - 가락시장 반입량 데이터
 - 나이스 지니 데이터
 - 서울특별시 물류창고 업체 인허가 정보 데이터
 - 소상공인시장 진흥공단 전국 전통시장 현황 데이터
...
<br>
 ...
 - Prophet 모듈을 통한 시계열 예측

 - haversine 을 통한 위경도 거리 계산
<br>
...
*보러가기: [****Logistics optimization system through demand forecast****](https://github.com/hwanginbeom/Portfolio_ML/tree/master/Logistics%20optimization%20system%20through%20demand%20forecast)*    

<br>

------

## #5. Project - 노래와 태그에 따른 플레이리스트 추천 시스템

- Background

멀티캠퍼스라는 교육기관에서 진행 했던 프로젝트 였습니다. 멜론 데이터를 통해 사용자가 노래와 태그를 선택하는 것에 따라 플레이 리스트를 추천 해주는 서비스를을 구현하였습니다.
...
<br>
 ...
 - 카카오 아레나를 통해 제공 받은 playlist data(플레이리스트 데이터), song meta data(노래 관련 데이터)
 - 웹을 구현하는데 있어서 사용하였던 youtube url / 멜론 앨범 이미지 크롤링
...
<br>
 ...
 - python의 pandas, numpy, gensim 라이브러리 통한 데이터 가공
...
<br>
 ...
 - Django를 통해 웹을 구현 / html 기반에 javascript와 jquery 사용
...
<br>
 ...
 - 노래와 태그 선택에 따라 맞춤 플레이 리스트 추천

 - 컨텐츠 기반 추천 시스템 구현

 - 알고리즘 별 성능차이 분석

 - 활용방안으로서 매장음악 서비스와 킬러 컨텐츠로서의 역할 수행
